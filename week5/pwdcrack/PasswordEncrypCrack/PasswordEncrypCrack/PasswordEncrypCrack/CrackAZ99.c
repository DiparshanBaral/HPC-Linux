...
int main(int argc, char *argv[])
{
  clock_t t;
  t = clock();
  crack("$6$AS$yV1IZEkqIjgtR7VqjKxmg963NfyFa0zte.7ItDmX6zSNKdiOudTXqo/fs.SZCf24bfw6bBwNAaf5mjQEZdXzl/"); // Copy and Paste your ecrypted password here using EncryptShA512 program
  t = clock() - t;
  double time_taken = ((double)t) / CLOCKS_PER_SEC; // in seconds
  printf("Crack took %f seconds to execute \n", time_taken);
